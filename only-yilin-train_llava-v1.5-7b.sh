...
yilin=True
similarity_weight=1
ls_factor_weight=0.3


run_name="only-yilin-$base_model-lr-$lr-acc_batch-$effective_batch-ls_factor_weight-$ls_factor_weight-similarity_weight-$similarity_weight-h100"
...
deepspeed --include=localhost:0,1 --master_port 60003 train_rdpo.py \
